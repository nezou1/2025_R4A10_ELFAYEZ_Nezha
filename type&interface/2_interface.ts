...
export interface StudentRepository extends FindMany<Student>, FindOne<Student>, Create<Student>, Update<Student>, Delete {}

export interface CourseRepository extends FindMany<Course>, FindOne<Course>, Create<Course>, Update<Course> {}
/*
